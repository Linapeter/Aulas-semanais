# [2018-05-04] Desafio #359 [Difícil] Primos em Grades
# Descrição
# Este quebra-cabeça foi proposto pela primeira vez (1989) por Gordon Lee:
# dada uma grade de números, quantos primos *distintos* você pode encontrar embutidos na matriz,
# considerando que você pode ler as linhas ou parte delas, na orientação vertical, horizontal ou diagonal, em ambas as direções.

# Observe que você não pode mudar de direção depois de começar a se mover (por exemplo, este não é o Boggle).

# Descrição de entrada
# Você receberá um único número em uma linha que informa quantas linhas e colunas devem ser lidas (todas as grades serão quadradas). Exemplo:
...
# Descrição da saída
# Seu programa deve emitir o número de primos distintos que encontrar na grade. Opcionalmente, liste-os. Exemplo:
